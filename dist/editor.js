...
var _remoteCursor = _interopRequireDefault(require("./remoteCursor"));
class Editor {
  ...
  updateRemoteCursor(position, siteId, opType, value) {
    ...
    if (remoteCursor) {
      ...
      var _this$controller$netw;
      const username = ((_this$controller$netw = this.controller.network.find(peerObj => peerObj.siteId === siteId)) === null || _this$controller$netw === void 0 ? void 0 : _this$controller$netw.userName) || 'Unnamed User';
      this.remoteCursors[siteId] = new _remoteCursor.default(this.mde, siteId, username, clonedPosition, this.document);
    }
  }
