...
class CRDT {
  constructor(controller) {
    let base = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 32;
    let boundary = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 10;
    let strategy = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'random';
  ...
  findPosition(char) {
    ...
    let currentLine, midLine, charIdx, minCurrentLine, lastChar, maxCurrentLine, minLastChar;
  ...
  generateChar(val, pos) {
    ...
    return new _char.default(val, this.vector.localVersion.counter, this.siteId, newPos);
  }
  ...
  generatePosBetween(pos1, pos2) {
    let newPos = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
    ...
    let id1 = pos1[0] || new _identifier.default(0, this.siteId);
    let id2 = pos2[0] || new _identifier.default(base, this.siteId);
    if (id2.digit - id1.digit > 1) {
      let newDigit = this.generateIdBetween(id1.digit, id2.digit, boundaryStrategy);
      newPos.push(new _identifier.default(newDigit, this.siteId));
      return newPos;
...
var _default = exports.default = CRDT;